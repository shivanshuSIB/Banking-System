...
const docTemplate = `{
    ...
    "paths": {
        "/accounts": {
            ...
            "post": {
                "description": "Create a new bank account with a name and currency",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/deposits": {
            "post": {
                "description": "Deposit external money into a bank account",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.ReversalRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.WithdrawalRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "domain.Transaction": {
            ...
            "properties": {
                "amount": {
                    "description": "cents, always positive",
                    "type": "integer"
                },
                "created_at": {
                    "type": "string"
